...
# Unzip files
zipFile <- "raw_data/PFTC4_Svalbard_2018_LeafScans.zip"
outDir <- "raw_data"
unzip(zipFile, exdir = outDir)

#### Check LeafIDs
# Load trait IDs
load("raw_data/envelope_codes.Rdata", verbose = TRUE)

# List of scan names
list.of.files <- dir(path = "raw_data/Leaf Scans/", pattern = "jpeg|jpg", recursive = TRUE, full.names = TRUE)
